...
mss_pdma_channel_id_t MSS_PDMA_first_free_channel(void)
{
	...
	volatile mss_pdma_t *pdmareg;

	for(chan = MSS_PDMA_CHANNEL_0; chan < MSS_PDMA_CHANNEL_3; chan++) {
       		pdmareg = (mss_pdma_t *)MSS_PDMA_REG_OFFSET(chan);
